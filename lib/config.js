...
// authorization-io base URL
curator['authorization-io'] = {};
curator['authorization-io'].baseUrl = 'https://authorization.io/dids/';

// maximum number of times to try to register a key w/a DID for a user
curator.maxRegisterDidKeyAttempts = 5;
...
curator.endpoints = {};
curator.endpoints.composeIdentity =
  '/tasks/credentials/compose-identity';
curator.endpoints.storeCredentials =
  '/tasks/credentials/store-credentials';

curator.tasks = {};
curator.tasks.storeCredential = {};
curator.tasks.storeCredential.claimCredential = false;
curator.tasks.composeIdentity = {};
