...
var ensureAuthenticated = brPassport.createAuthenticator(
  {allowUrlEncoded: true});
...
bedrock.events.on('bedrock-express.configure.routes', function(app) {
  ...
  app.post(
    ...
    ensureAuthenticated, acceptableContent('urlencoded'),
  ...
  app.post(
    '/tasks/request-credential-storage',
    ensureAuthenticated, acceptableContent('urlencoded'),
    parseForm, parseJsonData, function(req, res, next) {
    getDefaultViewVars(req, function(err, vars) {
      if(err) {
